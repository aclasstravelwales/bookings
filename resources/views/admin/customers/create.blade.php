    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.customers.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('customernames') ? 'is-invalid' : '' }}" name="customernames[]" id="customernames" multiple required>
                    @foreach($customernames as $id => $customername)
                        <option value="{{ $id }}" {{ in_array($id, old('customernames', [])) ? 'selected' : '' }}>{{ $customername }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('pickup_date') ? 'is-invalid' : '' }}" type="text" name="pickup_date" id="pickup_date" value="{{ old('pickup_date') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('pickup_time') ? 'is-invalid' : '' }}" type="text" name="pickup_time" id="pickup_time" value="{{ old('pickup_time') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('where_from') ? 'is-invalid' : '' }}" type="text" name="where_from" id="where_from" value="{{ old('where_from', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('where_to') ? 'is-invalid' : '' }}" type="text" name="where_to" id="where_to" value="{{ old('where_to', '') }}" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('wheelchair') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="wheelchair" id="wheelchair" value="1" {{ old('wheelchair', 0) == 1 ? 'checked' : '' }}>
